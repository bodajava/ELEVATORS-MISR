...
| `assets/CONPONENTS/2/2026-08-05 23.16.18.mp4`                                                                               | video | 1280x720 · 32s        | clear                 | **ships**    | Homepage film strip + /projects/wrought-iron-villa    | Only tiles on screen decode                       | Same strip, smaller frames | Poster first; source attached within 400px of viewport |                                                                               |
| `assets/CONPONENTS/3/2026-08-05 23.12.48.mp4`                                                                               | video | 624x832 · 39s         | people-consent        | **excluded** | — excluded 2026-08-09                                 | Two slides visible; only the active one plays     | One slide + peek of next   | Poster first; source attached within 400px of viewport |                                                                               |
| `assets/CONPONENTS/7/2026-08-05 23.24.59.mp4`                                                                               | video | 624x832 · 28s         | clear                 | **ships**    | Homepage film strip + /projects/chevron-marble-villa  | Only tiles on screen decode                       | Same strip, smaller frames | Poster first; source attached within 400px of viewport |                                                                               |
...
| `assets/VIDOES/SHOW PRODUT video/2026-08-05 23.12.11.mp4`                                                                   | video | 464x848 · 32s         | brand-name-conflict   | **excluded** | — excluded 2026-08-09                                 | Two slides visible; only the active one plays     | One slide + peek of next   | Poster first; source attached within 400px of viewport |                                                                               |
| `assets/VIDOES/SHOW PRODUT video/2026-08-05 23.13.14.mp4`                                                                   | video | 624x832 · 22s         | brand-name-conflict   | **excluded** | — excluded 2026-08-09                                 | Two slides visible; only the active one plays     | One slide + peek of next   | Poster first; source attached within 400px of viewport |                                                                               |
| `assets/VIDOES/SHOW PRODUT video/2026-08-05 23.17.10.mp4`                                                                   | video | 960x540 · 28s         | clear                 | **ships**    | Homepage film strip + /projects/chandelier-hall-villa | Only tiles on screen decode                       | Same strip, smaller frames | Poster first; source attached within 400px of viewport |                                                                               |
| `assets/VIDOES/SHOW PRODUT video/2026-08-05 23.20.17.mp4`                                                                   | video | 1280x720 · 41s        | clear                 | **ships**    | Homepage film strip + /projects/parquet-salon-villa   | Only tiles on screen decode                       | Same strip, smaller frames | Poster first; source attached within 400px of viewport |                                                                               |
| `assets/VIDOES/SHOW PRODUT video/2026-08-05 23.24.56.mp4`                                                                   | video | 464x848 · 86s         | people-consent        | **excluded** | — excluded 2026-08-09                                 | Two slides visible; only the active one plays     | One slide + peek of next   | Poster first; source attached within 400px of viewport |                                                                               |
| `assets/VIDOES/SHOW PRODUT video/savefromins.com  0 720P.mp4`                                                               | video | 640x1138 · 41s        | third-party-watermark | **excluded** | — excluded 2026-08-09                                 | Two slides visible; only the active one plays     | One slide + peek of next   | Poster first; source attached within 400px of viewport |                                                                               |
...
> video has been generated: no AI-video provider or credential is configured. The **four**
> approved films remain the public set until replacements exist and are approved.

> **Correction, 2026-08-09.** The public set was nine films until a frame-by-frame audit of the
> whole shipping set. Five were misclassified as `clear` and are now excluded: two carry a
> burned-in "Arab Egypt for elevators" watermark, one carries that plus a "HYDE PARK
> DEVELOPMENT" title card belonging to a third-party developer, and two show identifiable
> people. In each case the recorded note described the file's resolution or the absence of a
> watermark rather than what the footage shows — the same failure mode as the `AQMyyB….mp4`
> correction on 2026-08-08. Their ten derivatives were deleted from `public/`, where they had
> remained live and fetchable after being unlinked; `tests/unit/media-rights.test.ts` now fails
> on any orphan.

### The eleven held-back videos
...
| `CONPONENTS/3/2026-08-05 23.12.48.mp4`          | **Identifiable person, no publication consent.** A man walks into and out of the car, face visible in the opening and closing seconds. Added 2026-08-09.                  |
| `SHOW PRODUT video/2026-08-05 23.12.11.mp4`     | **Burned-in "Arab Egypt for elevators"** across every frame. Added 2026-08-09.                                                                                            |
| `SHOW PRODUT video/2026-08-05 23.13.14.mp4`     | **Burned-in "Arab Egypt for elevators"** across every frame. Added 2026-08-09.                                                                                            |
| `SHOW PRODUT video/2026-08-05 23.24.56.mp4`     | **Identifiable person, no publication consent.** A man stands inside the car, face visible. Added 2026-08-09.                                                             |
| `SHOW PRODUT video/savefromins.com  0 720P.mp4` | **Third-party brand and brand-name conflict.** Opens on a "HYDE PARK DEVELOPMENT" title card and carries the "ARAB EGYPT FOR ELEVATORS" watermark. Added 2026-08-09.      |
